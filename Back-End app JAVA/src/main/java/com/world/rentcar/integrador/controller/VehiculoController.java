...
public class VehiculoController {
    ...
    public ResponseEntity<Vehiculo> actualizarVehiculo(@RequestBody Vehiculo vehiculo)throws BadRequest {
        ResponseEntity<Vehiculo> response = null;

        if (vehiculo.getId() != null && vehiculoService.buscarxID(vehiculo.getId()).isPresent())
            response = ResponseEntity.ok(vehiculoService.modificar(vehiculo));
        else
