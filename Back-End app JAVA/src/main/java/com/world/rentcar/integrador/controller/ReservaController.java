...
public class ReservaController {
    ...
    @PatchMapping("/{reservaId}/ocultar")
    public ResponseEntity<String> ocultarReserva(@PathVariable Long reservaId) {
        try {
            reservaService.ocultarReserva(reservaId);
            return ResponseEntity.ok("Reserva con id:"+reservaId+" oculta exitosamente");
        } catch (BadRequest e) {
